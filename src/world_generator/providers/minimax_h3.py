...
def build_h3_content(
    ...
    *,
    ...
    content.extend(_media_item(item, max_inline_bytes=max_inline_bytes) for item in references)
    return content
...
class MiniMaxH3Client(VideoProvider):
    ...
    def generate(
        ...
        *,
        ...
        if use_context_ir:
            content = cast(list[dict[str, object]], base_payload["content"])
